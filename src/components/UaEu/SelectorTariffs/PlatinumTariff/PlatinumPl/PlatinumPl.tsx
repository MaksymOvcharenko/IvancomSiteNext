...
import s from "./Platinum.Pl.module.css";
...
const PlatinumPl = () => {
  const t = useTranslations('UaEu.ParcelsUaEu.Platinum.PlatinumPL');
  ...
  rows: [
    ...
    { weight: "від 2 кг", price: "Перші 2 кг (включно) - 100 zł, кожен наступний кілограм 20 zł/кг" },
