...
const t = useTranslations("UaEu.ParcelsUaEu.Silver.Table");




export const deliveryIvankomPL: DeliveryTableData = {
  title: t('tables.ivankomBranch'),
  country:  t('country.pl'),
  rows: [
...
export const courierIvankomPrices: DeliveryTableData = {
  title: t('tables.courier'),
  country: t('country.pl'),
  rows: [
...
export const inpostDeliveryPL: DeliveryTableData = {
  title: t('tables.inpost'),
  country:  t('country.pl'),
  rows: [
