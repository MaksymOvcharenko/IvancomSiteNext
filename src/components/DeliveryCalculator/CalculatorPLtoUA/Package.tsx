...
//       <h2 className={styles.title}>Посилка {id}</h2>
//       <div className={styles.dimensions}>
//         <label className={styles.label}>Довжина (см): <input className={styles.input} type="number" id={`length${id}`} /></label>
//         <label className={styles.label}>Ширина (см): <input className={styles.input} type="number" id={`width${id}`} /></label>
//         <label className={styles.label}>Висота (см): <input className={styles.input} type="number" id={`height${id}`} /></label>
//       </div>
//       <div className={styles.field}>
//         <label className={styles.label}>Фактична вага (кг): <input className={styles.inputWeight} type="number" id={`weight${id}`} /></label>
